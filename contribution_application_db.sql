...
--
-- Host: localhost:8889
-- Generation Time: Apr 03, 2021 at 07:53 AM
...
--
-- Database: `contribution_application_db`
--
...
CREATE TABLE `file_content` (
                                ...
                                `file_content_name` varchar(512) NOT NULL,
...
(45, 'd94ae0d6ce48f3c4691a583d30f50dfa4A76F959-31D9-4C49-BADD-BDF58593C379.jpg', 1617286474, 64),
(46, 'd94ae0d6ce48f3c4691a583d30f50dfa45C64A49-E3CC-4FE8-8DAA-93ED181C53C1.jpg', 1617286474, 64),
(50, '87f6f06a7ee7dd77d33ecb00b75bd7c6158384890_147610643901366_5275522211667288605_n.png', 1617286554, 66),
(51, 'df327123eb351a5261a5380aa86604bc45C64A49-E3CC-4FE8-8DAA-93ED181C53C1.jpg', 1617287563, 67),
(52, 'f396cefb21ebcbd5484cba83c37a0edf45C64A49-E3CC-4FE8-8DAA-93ED181C53C1.jpg', 1617287728, 68),
(94, '95d9fee8b48b979994249256ecd052593 loại người dùng.docx', 1617330189, 114);
...
INSERT INTO `file_submit_to_submission` (`id`, `file_name`, `file_authod`, `file_status`, `file_date_uploaded`, `file_submission_uploaded`, `file_userId_uploaded`) VALUES
(64, 'Chinh', 'student 1 ', 2, '2021-04-01 21:14:34', 25, 44),
(66, 'Môn 1', 'student 2', 1, '2021-04-01 21:15:54', 25, 45),
(67, 'a', 'student 1 ', 3, '2021-04-01 21:32:43', 26, 44),
(68, 'Chinh', 'student 1 ', 1, '2021-04-01 21:35:28', 27, 44),
(114, 'a123', 'student 1 ', 1, '2021-04-02 09:23:09', 28, 44);
...
INSERT INTO `submission` (`id`, `submission_name`, `submission_description`, `submission_deadline`) VALUES
(25, 'Submission môn 2', 'Submission oke', '2021-03-24 16:07:00'),
(26, 'Submission môn 3', 'Nộp bài môn 3', '2021-03-24 16:11:00'),
(27, 'Submission môn 4', 'Nộp bài môn 4', '2021-03-23 16:12:00'),
(28, 'Submission môn 12', 'Submission oke', '2021-03-20 19:35:00'),
(29, 'adadad', 'ad', '2021-03-24 10:15:00'),
(30, '235235', '235235235235', '2021-04-01 20:09:00'),
(34, 'ad1234124', 'ad123124', '2021-04-02 16:25:00'),
(35, 'ad123', 'ad1234', '2021-04-02 17:13:00'),
(36, 'ad123456', 'ad123456', '2021-04-02 17:13:00');
...
(1, 44, 45, 'day la chat 1', '2021-03-11 00:22:33'),
(2, 44, 46, 'day lag chat 2', '2021-03-17 00:22:33'),
(18, 45, 46, 'char', '2021-03-23 01:06:09'),
(27, 44, 46, 'ggfu', '2021-03-23 01:19:48'),
(44, 45, 44, 'ai guitar', '2021-03-23 02:03:42'),
(45, 45, 44, 'tao gui', '2021-03-23 02:04:01'),
(46, 45, 44, 't gui', '2021-03-23 02:04:18'),
(47, 46, 45, 't gui', '2021-03-23 02:04:48'),
(48, 46, 45, '5756', '2021-03-23 02:05:27'),
(49, 44, 45, '5756', '2021-03-23 02:05:46'),
(50, 44, 45, 'du ma', '2021-03-23 02:13:31'),
(51, 45, 44, 'annas', '2021-03-23 02:55:23'),
(52, 44, 45, '12345', '2021-04-02 11:02:05'),
(53, 44, 45, 'does hieu', '2021-04-02 11:02:12'),
(54, 44, 45, 'char', '2021-04-02 11:02:20'),
(55, 44, 45, 'char', '2021-04-02 11:04:10'),
(56, 44, 45, 'char', '2021-04-02 11:04:34'),
(57, 44, 45, 'char', '2021-04-02 11:06:25'),
(58, 44, 45, 'char', '2021-04-02 11:06:59'),
(59, 44, 46, 'chart', '2021-04-02 11:07:15'),
(60, 44, 46, 'eso ddl', '2021-04-02 11:07:28');
...
(1, 'marketing1', '123456', 'hieunt1@gmail.com', 1, 1616576204, 1616576204, 'Nguyễn Trung Hiếu', 'manager-marketing', 22),
(2, 'customer1', '123456', 'hieunt2@gmail.com', 1, 1616576204, 1616576204, 'Nguyễn Trung Hiểu', 'customer', 22),
...
(53, 'student7', '123456', 'truongbachinh1998@gmail.com', 1, 1616589316, 0, 'student 7', 'student', 28);
...
--
ALTER TABLE `faculty`
    MODIFY `f_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `file_comment`
--
ALTER TABLE `file_comment`
    MODIFY `file_comment_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `file_content`
--
ALTER TABLE `file_content`
    MODIFY `file_content_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
...
--
ALTER TABLE `user`
    MODIFY `u_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
